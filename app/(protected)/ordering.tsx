...
// const CartTab = ({ cart, products, updateQuantity, removeFromCart, onPlaceOrder, onCancel }) => {
...
// 		const subTotal = cartDetails.reduce((acc, item) => acc + (parseFloat(item.product.price) * item.quantity), 0);
...
// 							</View>
// 							<Button size="icon" variant="ghost" onPress={() => removeFromCart(item.product_id)}><LucideIcon name="Trash2" size={20} className="text-destructive" /></Button>
// 						</CardContent>
// 					</Card>
// 				))}
// 			</View>
...
// 			};
// 			const newOrder: Order = await wooApiFetch('orders', { method: 'POST', body: orderData });
...
// 					removeFromCart={handleRemoveFromCart} onPlaceOrder={handlePlaceOrder}
