...
// 										<LucideIcon name="Plus" size={24} className="flex text-primary-foreground" />
// 									</Button>
// 								</View>
// 								<View className="px-2">
...
// 															<LucideIcon className="w-6" name="Building" size={12} />
// 															{contact.business_name || "-"}
// 														</P>
// 														<P className="text-sm text-primary/85 mb-1 flex items-center gap-1">
// 															<LucideIcon className="w-6" name="Phone" size={12} />
// 															{contact.user_mobile || contact.business_number || "-"}
// 														</P>
// 														<P className="text-sm text-primary/85 mb-1 flex items-center gap-1">
// 															<LucideIcon className="w-6" name="Mail" size={12} />
// 															{contact.user_email || "-"}
// 														</P>
// 														<P className="text-sm text-primary/85 mb-1 flex items-center gap-1">
// 															<LucideIcon className="w-6" name="MapPin" size={12} />
